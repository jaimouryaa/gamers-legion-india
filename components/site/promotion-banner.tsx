  ...
  return (
    <section className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <div className="relative overflow-hidden rounded-3xl border border-border-glass bg-gradient-to-br from-surface via-surface-elevated to-surface p-10 sm:p-14">
        <div className="pointer-events-none absolute -left-10 -top-16 h-64 w-64 rounded-full bg-accent-violet/25 blur-[100px]" />
        <div className="pointer-events-none absolute -right-10 -bottom-16 h-64 w-64 rounded-full bg-accent-primary/25 blur-[100px]" />
        <div className="relative flex flex-col items-start gap-6 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link
            ...
            className="group inline-flex shrink-0 items-center gap-2 rounded-full bg-gradient-to-r from-accent-primary to-accent-secondary px-6 py-3 text-sm font-medium text-[#fdf1f3] shadow-[0_0_24px_-6px_rgba(53,224,238,0.55)] transition-transform hover:scale-[1.03]"
          >
            {PROMOTION.ctaLabel}
