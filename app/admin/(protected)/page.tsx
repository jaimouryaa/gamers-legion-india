  ...
  return (
    <div>
      ...
      <div className="mt-6 grid grid-cols-2 gap-4 lg:grid-cols-4">
        <KpiCard icon={Gamepad2} value={kpis.totalGames} label="Total games" />
        <KpiCard icon={Tag} value={kpis.activeDeals} label="Active deals" />
        <KpiCard icon={Star} value={kpis.featured} label="Featured" />
        <KpiCard icon={Clock3} value={kpis.expiringToday} label="Expiring today" />
      </div>
